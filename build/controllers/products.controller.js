...
var getMany = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
var deleteOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, productmodel.deleteOne(id)];
            case 2:
                _a.sent();
                res.json("product ".concat(id, " deleted"));
                return [3 /*break*/, 4];
            case 3:
                error_5 = _a.sent();
                next(error_5);
