...
var handleAuthenticationError = function (next) {
        ...
        try {
            ...
            if (authHeader) {
                ...
                if (bearer && token === 'bearer') {
                    decode = jsonwebtoken_1.default.verify(token, config_1.default.token);
                    if (decode) {
                        next();
                    }
                    else {
...
exports.default = { validateToken: validateToken };
